...
<body>
	...
	<form action="${conPath }/write.do" method="post">
		...
		<input type="hidden" name="bgroup" value="${replyBoard.bgroup }"> <!-- 원글bgroup -->
		<input type="hidden" name="bstep" value="${replyBoard.bstep }"> <!-- 원글bstep -->
		<input type="hidden" name="bindent" value="${replyBoard.bindent }"> <!-- 원글bindent -->
		<table>
