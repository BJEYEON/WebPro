...
<body>
	...
	<%
		...
		ArrayList<BoardDto> dtos = bDao.listboard(1,10);
		...
		out.print(result == BoardDao.SUCCESS ? "성공</h3>" : "실패</h3>");
		out.print("<h4>8. 글삭제");
		result = bDao.deleteboard(190, "2");
		out.print(result == BoardDao.SUCCESS? "글삭제 성공<br>":"비번오류로 글삭제 실패");
		result = bDao.deleteboard(190, "111");
