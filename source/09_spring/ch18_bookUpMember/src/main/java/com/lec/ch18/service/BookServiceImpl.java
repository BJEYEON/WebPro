...
public class BookServiceImpl implements BookService {
	String backupPath = "E:\\WebPro\\source\\09_spring\\ch18_bookUpMember\\src\\main\\webapp\\bookimgFileUpload\\";
	@Autowired
	...
	public List<Book> bookList(String pageNum) {
		Paging paging = new Paging(bookRepository.totCntBook(), pageNum, 10, 10);
		Book book = new Book();
