...
-- 1. 글목록(startRow부터endRow) id=boardList
...
-- 4. bid로 조회수 1올리기 id=boardHitUp
UPDATE MVCBOARD SET BHIT = BHIT+1 WHERE BID=1;
-- 5. bid로 dto가져오기 getBoardDto
SELECT * FROM MVCBOARD WHERE BID=1;
-- 6. 글수정 id=boardModify
UPDATE MVCBOARD
    SET BNAME = '김',
        BTITLE = '제목1',
        BCONTENT = '내용1',
